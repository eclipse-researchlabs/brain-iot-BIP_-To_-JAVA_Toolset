...
@Task(time=2)
public class moveToStorage extends Connector { 
public moveToStorage(ReqMoveToStorage m, ReqMoveToStorage s){this.m=m; 
...
txt.setVal("("  + m.varid.getVal() + ")-->"  + "("  + s.varid.getVal() + ") [Orchestrator] Orchestrator send REQ to MoveToStorage"  );
