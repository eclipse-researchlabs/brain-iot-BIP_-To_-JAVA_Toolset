...
public class Command {
	...
	public static int checkMarkers(){
		ComponentImpl.checkMarkers();
		int i=0;
		while(i==0) {
			if(ComponentImpl.checkreturnedvalue!=null) {
			i=1;	
			}
		}
		
		int q = ComponentImpl.checkreturnedvalue.value;
		ComponentImpl.checkreturnedvalue=null;
		return q;
	}
	...
	public static int queryState(int RobotId, int mission){
		int i=0;
		ComponentImpl.queryState(RobotId, mission);
		while(i==0) {
			if(ComponentImpl.queryreturnedvalue!=null) {
			i=1;	
			}
		}
		int q = ComponentImpl.queryreturnedvalue.value;
		ComponentImpl.queryreturnedvalue=null;
		return q;
