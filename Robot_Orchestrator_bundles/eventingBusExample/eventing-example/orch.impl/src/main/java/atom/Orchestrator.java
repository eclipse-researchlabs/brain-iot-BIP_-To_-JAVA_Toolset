...
initial.setVal(false);
 ...
 public int p1(){
 int _r=0;
 if(  START.getVal( )==true  && p1.isAvailable() == false  && (CPT.getVal() == 1 ) )
{
...
_r=1;
 ...
 public int p14(){
 int _r=0;
 if(  S11.getVal( )==true  && p14.isAvailable() == false  && (QUERYSTATE.getVal() == FINISHED.getVal() ) )
{
...
MARKER.setVal( Command.checkMarkers( ) );
...
_r=1;
 ...
 public int p18(){
 int _r=0;
 if(  S11.getVal( )==true  && p18.isAvailable() == false  && (QUERYSTATE.getVal() != FINISHED.getVal() ) )
{
...
_r=1;
 ...
 public int p15(){
 int _r=0;
 if(  S10.getVal( )==true  && p15.isAvailable() == false  && (MARKER.getVal() == 0 ) )
{
...
_r=1;
 ...
 public int p16(){
 int _r=0;
 if(  S10.getVal( )==true  && p16.isAvailable() == false  && (MARKER.getVal() != 0 ) )
{
...
_r=1;
 ...
 public int p6(){
 int _r=0;
 if(  S3.getVal( )==true  && p6.isAvailable() == false  )
{
...
_r=1;
 ...
 public int p8(){
 int _r=0;
 if(  S4.getVal( )==true  && p8.isAvailable() == false  )
{
...
_r=1;
 ...
 public int p9(){
 int _r=0;
 if(  S6.getVal( )==true  && p9.isAvailable() == false  && (QUERYSTATE.getVal() == FINISHED.getVal() ) )
{
p9.setAvailable(true);  
}
 if( p9.isAvailable() ){
p9.setAvailable(false);
 Command.writeGOTO( CPT.getVal() , PLACECENTER.getVal() );
 Command.writeOpenDoor( );
...
_r=1;
 ...
 public int p10(){
 int _r=0;
 if(  S6.getVal( )==true  && p10.isAvailable() == false  && (QUERYSTATE.getVal() != FINISHED.getVal() ) )
{
...
_r=1;
 ...
 public int p11(){
 int _r=0;
 if(  S7.getVal( )==true  && p11.isAvailable() == false  )
{
...
_r=1;
 ...
 public int p17(){
 int _r=0;
 if(  S8.getVal( )==true  && p17.isAvailable() == false  && (LOAD.getVal() == 0 ) )
{
...
_r=1;
 ...
 public int p19(){
 int _r=0;
 if(  S9.getVal( )==true  && p19.isAvailable() == false  && (LOAD.getVal() == 0 ) )
{
...
_r=1;
 ...
 public int p20(){
 int _r=0;
 if(  S12.getVal( )==true  && p20.isAvailable() == false  && (QUERYSTATE.getVal() == FINISHED.getVal() ) )
{
...
_r=1;
 ...
 public int p21(){
 int _r=0;
 if(  S12.getVal( )==true  && p21.isAvailable() == false  && (QUERYSTATE.getVal() != FINISHED.getVal() ) )
{
...
_r=1;
 ...
 public int p12(){
 int _r=0;
 if(  S8.getVal( )==true  && p12.isAvailable() == false  && (QUERYSTATE.getVal() == FINISHED.getVal() && LOAD.getVal() != 0 ) )
{
...
_r=1;
 ...
 public int p13(){
 int _r=0;
 if(  S8.getVal( )==true  && p13.isAvailable() == false  && (QUERYSTATE.getVal() != FINISHED.getVal() ) )
{
