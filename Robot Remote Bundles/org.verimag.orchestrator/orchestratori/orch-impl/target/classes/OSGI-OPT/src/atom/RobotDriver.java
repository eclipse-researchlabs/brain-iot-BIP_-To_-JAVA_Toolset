...
_r=1;
 ...
 int _r=0;
 if(  CTRLMOVEDOCK.getVal( )==true  && silent_getStateReqMoveToDock.isAvailable() == false  )
{
...
_r=1;
 ...
 int _r=0;
 if(  CTRLMOVEUNLOAD.getVal( )==true  && silent_getStateReqMoveToUnload.isAvailable() == false  )
{
...
_r=1;
 ...
 int _r=0;
 if(  CTRLMOVESTORAGE.getVal( )==true  && silent_getStateReqMoveToStorage.isAvailable() == false  )
{
